...
class SimPyNetwork:
    ...
    def __init__(
        ...
        self.round_stats = defaultdict(lambda: {        # Per-round counters (Phase 7 CSV columns).
            ...
            'forged':0, 'same_round_replayed':0, 'stale_replayed':0
        })
            ...
            if is_substitute or is_extra:
                ...
                if is_extra:
                    ...
                    if out_msg.fault_type == 'replay':
                        ...
                        if out_msg.round_id == msg.round_id:
                            self.round_stats[msg.round_id]['same_round_replayed'] +=1
                        else:
                            self.round_stats[msg.round_id]['stale_replayed'] +=1
